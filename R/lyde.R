#' Spatial dataset for SLF presence at 1km resolution
#'
...
#'
#'@format A dataframe with 1,193,028 observations and 14 variables
#' \describe{
...
#'   \item{source_agency}{Agency/organization/platform responsible for data collection. `DDA`: Delaware Dept of Agriculture; `Indiana_DNR`: Indiana Dept of Natural Resources; `MDA`: Maryland Dept of Agriculture; `NJDA_Public_reporting`: New Jersey Dept of Agriculture public reporting tool platform; `NYSDAM`: New York State Dept of Agriculture and Markets; `PDA`: Pennsylvania Dept of Agriculture; `PDA_Public_reporting`:  Pennsylvania Dept of Agriculture public reporting tool platform; `VA_Tech_Coop_Ext`: Virginia Polytechnic Institute and State University, and Virginia Cooperative Extension; `VDA`: Virginia Dept of Agricuture; `Ohio_DA_Public_reporting`: Ohio Dept of Agriculture public reporting tool platform; `GDA_Public_reporting`: Georiga Dept of Agriculture public reporting tool platform; `Missouri_DA`: Missouri Dept of Agriculture; `North_Carolina_DA&CS`: North Carolina Dept of Agriculture and Consumer Services; `Oregon_DA`: Oregon Dept of Agriculture; `Clemson_University`: Clemson University, South Carolina; `Vermont_AAFM`: Vermont Agency of Agriculture, Food and Markets; `Washington_State_DA`: Washington State Dept Agriculture; `Wisconsin_DATCP`: Wisconsin Dept of Agriculture, Trade, and Consumer Protection; `University_of_Kentucky`: University of Kentucky, Kentucky; `Michigan_DARD`: Michigan Dept of Agriculture and Rural Development; `Illinois_DA`: Illinois Dept of Agriculture; `USDA`: United States Dept of Agriculture.}
