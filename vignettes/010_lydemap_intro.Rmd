...
knitr::kable(data_summary(year_type = "biological"))
```
...
The map can be saved as a pdf file a high resolution (this file will be saved in the `vignettes` folder).
